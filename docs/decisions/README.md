...
| [ADR-011 — State-Derived Print-First Approval Reports](ADR-011-state-derived-print-report.md) | Detached report projection, dedicated print DOM and native browser Save as PDF |
