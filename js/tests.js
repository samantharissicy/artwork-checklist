...
(function () {
  ...
  function resetWorkspaceForMultiProductTest() {
    ...
    appState.schemaVersion = CURRENT_SCHEMA_VERSION;
  ...
  window.runArtworkTests = async function runArtworkTests() {
    ...
    console.group(
      "%cArtwork Checklist — Layer B + C + D + E + G Test Suite",
  ...
  console.info(
    "Artwork Layer B + C + D + E + G tests loaded. Run: runArtworkTests()",
  );
})();
